...
- **1er cochon** : Plateforme d'herbe dans la BB d'un biome plaine/savane → spawns naturels possibles
- **Carottes / pommes de terre** pour reproduire (drop zombie via player kill — voir succès `zombie_crop`)
- **3 lingots de cuivre** pour le paratonnerre
...
| Méthode | Difficulté |
|---|---|
| Plateforme d'herbe dans biome pouvant faire spawn des animaux passifs → spawn naturel.

### Étape 2 — Élever les cochons

Une fois 2 cochons obtenus :
- Donne **1 carotte / pomme de terre / betterave** à chacun → mode amour → bébé
- Compte ~20 min de croissance pour le bébé adulte

Cible : **140** minimum dans ton enclos pour optimiser le retour par orage.
...
- 0-1 **pépite d'or** (50% de chance)
- 0-1 **lingot d'or** (rare, ~2,5%)
- 0-1 **chair putréfiée**
...
```
Phase 1 — Farm de zombies + fer (~1200 kills pour ~10 lingots de fer = chaudron + seau)
