...
Affiche la seed de ton monde. À copier dans **[chunkbase.net](https://www.chunkbase.net)** (onglet "Apps" → Biome Finder ou Structure Finder) pour planifier tes explorations depuis le spawn.
