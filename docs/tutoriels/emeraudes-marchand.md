...
Les villageois normaux ne spawnent pas naturellement sur ton île (pas de village généré). Mais les **zombies villageois** spawnent à **5%** des spawns de zombies normaux.
...
Pour **transformer un zombie villageois en villageois normal** :
...
1. Coince le zombie villageois dans ta cage (assure-toi qu'il ne peut pas fuir)
2. Lance la **potion de Faiblesse jetable** sur lui → il a l'effet Faiblesse
3. Clic-droit sur lui avec la **pomme d'or** en main → animation de soin commence
4. Particules rouges autour de lui pendant **5 minutes** (raccourcissable en plaçant des barreaux de fer ou des lits autour pour réduire le prix des trades)
...
- [Mécanique : Marchand ambulant](../vocabulaire.md#marchand-ambulant-wandering-trader)
- [Mécanique : Fleurs hautes via marchand](../mecaniques/mobs.md#fleurs-hautes-via-marchand-ambulant)
- [Mécanique : Cure zombie villageois (succès)](../mecaniques/mobs.md)
