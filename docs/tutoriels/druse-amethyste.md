...
!!! info "Vidéo à venir"
    Le tuto vidéo sera ajouté ici. Pour l'instant, suis le tuto écrit avec captures ci-dessous.

<!-- Quand la vidéo sera prête, remplace ce bloc par :
<iframe
  width="100%"
  height="500"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Druse d'améthyste — Tuto Vanilla Sky TdR"
  frameborder="0"
